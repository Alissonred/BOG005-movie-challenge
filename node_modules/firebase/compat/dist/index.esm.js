...
import { serverTimestamp, increment, enableLogging, _validatePathString, onChildMoved, onChildChanged, onChildRemoved, onChildAdded, onValue, off, get, query, limitToFirst, limitToLast, orderByChild, orderByKey, orderByPriority, orderByValue, startAt, startAfter, endAt, endBefore, equalTo, _ReferenceImpl, _QueryImpl, _QueryParams, child, set, _validateWritablePath, update, setWithPriority, remove, runTransaction, setPriority, push, OnDisconnect as OnDisconnect$1, connectDatabaseEmulator, refFromURL, ref, goOffline, goOnline, _setSDKVersion, _repoManagerDatabaseFromApp } from '@firebase/database';
import { enableIndexedDbPersistence, enableMultiTabIndexedDbPersistence, clearIndexedDbPersistence, _DatabaseId, _logWarn, connectFirestoreEmulator, enableNetwork, disableNetwork, _validateIsNotUsedTogether, waitForPendingWrites, onSnapshotsInSync, FirestoreError, collection, doc, collectionGroup, runTransaction as runTransaction$1, ensureFirestoreConfigured, WriteBatch as WriteBatch$1, executeWrite, loadBundle, namedQuery, _cast, DocumentReference as DocumentReference$1, DocumentSnapshot as DocumentSnapshot$1, _DocumentKey, refEqual, setDoc, updateDoc, deleteDoc, onSnapshot, getDocFromCache, getDocFromServer, getDoc, snapshotEqual, query as query$1, where, orderBy, limit, limitToLast as limitToLast$1, startAt as startAt$1, startAfter as startAfter$1, endBefore as endBefore$1, endAt as endAt$1, queryEqual, getDocsFromCache, getDocsFromServer, getDocs, QuerySnapshot as QuerySnapshot$1, addDoc, GeoPoint, Timestamp, CACHE_SIZE_UNLIMITED, Bytes, AbstractUserDataWriter, setLogLevel as setLogLevel$1, QueryDocumentSnapshot as QueryDocumentSnapshot$1, _debugAssert, FieldPath as FieldPath$1, _FieldPath, serverTimestamp as serverTimestamp$1, deleteField, arrayUnion, arrayRemove, increment as increment$1, _isBase64Available } from '@firebase/firestore';
import '@firebase/functions-compat';
import '@firebase/messaging-compat';
import { _TaskState, _TaskEvent, StringFormat, _getChild, uploadBytesResumable, _dataFromString, _UploadTask, _FbsBlob, listAll, list, getMetadata, updateMetadata, getDownloadURL, deleteObject, _invalidRootOperation, _invalidArgument, ref as ref$1, _Location, connectStorageEmulator } from '@firebase/storage';
...
class Query$1 {
    ...
    limitToFirst(limit) {
        ...
        return new Query$1(this.database, query(this._delegate, limitToFirst(limit)));
    }
    /**
    ...
    limitToLast(limit) {
        ...
        return new Query$1(this.database, query(this._delegate, limitToLast(limit)));
    }
    /**
    ...
    orderByChild(path) {
        ...
        return new Query$1(this.database, query(this._delegate, orderByChild(path)));
    }
    /**
    ...
    orderByKey() {
        ...
        return new Query$1(this.database, query(this._delegate, orderByKey()));
    }
    /**
    ...
    orderByPriority() {
        ...
        return new Query$1(this.database, query(this._delegate, orderByPriority()));
    }
    /**
    ...
    orderByValue() {
        ...
        return new Query$1(this.database, query(this._delegate, orderByValue()));
    }
    startAt(value = null, name) {
        validateArgCount('Query.startAt', 0, 2, arguments.length);
        return new Query$1(this.database, query(this._delegate, startAt(value, name)));
    }
    startAfter(value = null, name) {
        validateArgCount('Query.startAfter', 0, 2, arguments.length);
        return new Query$1(this.database, query(this._delegate, startAfter(value, name)));
    }
    endAt(value = null, name) {
        validateArgCount('Query.endAt', 0, 2, arguments.length);
        return new Query$1(this.database, query(this._delegate, endAt(value, name)));
    }
    endBefore(value = null, name) {
        validateArgCount('Query.endBefore', 0, 2, arguments.length);
        return new Query$1(this.database, query(this._delegate, endBefore(value, name)));
    }
    /**
    ...
    equalTo(value, name) {
        ...
        return new Query$1(this.database, query(this._delegate, equalTo(value, name)));
    }
    /**
...
class Firestore {
    ...
    runTransaction(updateFunction) {
        return runTransaction$1(this._delegate, transaction => updateFunction(new Transaction(this, transaction)));
    }
    batch() {
...
class Query {
    ...
    where(fieldPath, opStr, value) {
        try {
            ...
            return new Query(this.firestore, query$1(this._delegate, where(fieldPath, opStr, value)));
        }
        catch (e) {
    ...
    orderBy(fieldPath, directionStr) {
        try {
            ...
            // FieldPath Compat type as input, but is not typed as such in order to
            // not expose this via our public typings file.
            return new Query(this.firestore, query$1(this._delegate, orderBy(fieldPath, directionStr)));
        }
        catch (e) {
            throw replaceFunctionName(e, /(orderBy|where)\(\)/, 'Query.$1()');
        }
    ...
    limit(n) {
        try {
            return new Query(this.firestore, query$1(this._delegate, limit(n)));
        }
        catch (e) {
    ...
    limitToLast(n) {
        try {
            return new Query(this.firestore, query$1(this._delegate, limitToLast$1(n)));
        }
        catch (e) {
    ...
    startAt(...args) {
        try {
            return new Query(this.firestore, query$1(this._delegate, startAt$1(...args)));
        }
        catch (e) {
    ...
    startAfter(...args) {
        try {
            return new Query(this.firestore, query$1(this._delegate, startAfter$1(...args)));
        }
        catch (e) {
    ...
    endBefore(...args) {
        try {
            return new Query(this.firestore, query$1(this._delegate, endBefore$1(...args)));
        }
        catch (e) {
    ...
    endAt(...args) {
        try {
            return new Query(this.firestore, query$1(this._delegate, endAt$1(...args)));
        }
        catch (e) {
...
firebase.registerVersion(name$3, version$3, 'compat');
