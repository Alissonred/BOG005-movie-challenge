 ...
 */
firebase__default['default'].registerVersion(name$3, version$3, 'app-compat');

var name$2 = "firebase";
var version$2 = "9.0.0-2021720181311";
...
const name$1 = "@firebase/database-compat";
...
function initStandalone({ app, url, version, customAuthImpl, namespace, nodeAdmin = false }) {
    ...
    authProvider.setComponent(new Component$1('auth-internal', () => customAuthImpl, "PRIVATE" /* PRIVATE */));
    return {
...
function registerDatabase(instance) {
    ...
    instance.INTERNAL.registerComponent(new Component$1('database-compat', (container, { instanceIdentifier: url }) => {
        /* Dependencies */
 ...
 * limitations under the License.
 */
firebase__default['default'].registerVersion(name$2, version$2, 'compat-rn');
