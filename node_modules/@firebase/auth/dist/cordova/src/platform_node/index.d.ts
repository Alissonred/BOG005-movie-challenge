...
export declare const browserLocalPersistence: import("@firebase/util").FirebaseError;
export declare const browserSessionPersistence: import("@firebase/util").FirebaseError;
export declare const indexedDBLocalPersistence: import("@firebase/util").FirebaseError;
export declare const browserPopupRedirectResolver: import("@firebase/util").FirebaseError;
