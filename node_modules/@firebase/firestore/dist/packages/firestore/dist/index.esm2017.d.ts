 ...
 */ declare class eh {
    ...
    convertTimestamp(t: any): H;
    convertDocumentKey(t: any, e: any): gt;
}
/**
 * @license
 * Copyright 2020 Google LLC
 ...
 * @internal
 */ declare class gt {
    static fromPath(t: any): gt;
    static fromName(t: any): gt;
 ...
 */ declare class st extends tt {
     ...
     */ static fromServerFormat(t: any): st;
    static emptyPath(): st;
    construct(t: any, e: any, n: any): st;
    canonicalString(): any;
    toString(): any;
    /**
 ...
 */ declare class Sc {
     ...
     */ Ra(): Promise<void>;
    Aa(t: any): Promise<any>;
    enqueueAfterDelay(t: any, e: any, n: any): bo;
    Ia(): void;
     ...
     */ Sa(t: any): void;
    /** Called once a DelayedOperation is run or canceled. */ Pa(t: any): void;
}
/**
 * @license
 * Copyright 2017 Google LLC
 ...
 */ declare class ru {
    ...
    R: any;
    /** Creates a new top-level parse context. */ Ua(t: any, e: any, n: any, s?: boolean): iu;
}
/**
 * @license
 * Copyright 2017 Google LLC
...
/** A CredentialsProvider that always yields an empty token. */ declare class oc {
    /**
...
declare class bo {
     ...
     */ static createAndSchedule(t: any, e: any, n: any, s: any, i: any): bo;
    constructor(t: any, e: any, n: any, s: any, i: any);
    asyncQueue: any;
    timerId: any;
    targetTimeMs: any;
...
/** A "context" object passed around while parsing user data. */ declare class iu {
    ...
    get path(): any;
    get Ca(): any;
    /** Returns a new context with the specified settings overwritten. */ Na(t: any): iu;
    xa(t: any): iu;
    Oa(t: any): iu;
    Fa(t: any): iu;
    Ma(t: any): N;
 ...
 * limitations under the License.
 */
/** A field path and the TransformOperation to perform upon it. */ declare class $e {
    constructor(t: any, e: any);
    field: any;
    transform: any;
}
...
declare namespace br {
    const UNAUTHENTICATED: br;
    const GOOGLE_CREDENTIALS: br;
    const FIRST_PARTY: br;
    const MOCK_USER: br;
}
